...
class TestMathFunctions(unittest.TestCase):
    ...
    def test_example_from_prompt(self):
        ...
        self.assertEqual(convex_hull_jarvis(points), [(0, 3), (3, 3), (3, 0), (0, 0)])
    ...
    def test_duplicates(self):
        ...
        self.assertEqual(convex_hull_jarvis(points), -1)

    def test_all_collinear(self):
        points = [(0, 0),(1,1), (2, 2), (3,3), (4,4)] 
        self.assertEqual(convex_hull_jarvis(points), -2)

    def test_two_points(self):
        points = [(0, 3), (2, 2)] 
        self.assertEqual(convex_hull_jarvis(points), [(0, 3), (2, 2)])

    def test_single_point(self):
        points = [(0, 3)] 
        self.assertEqual(convex_hull_jarvis(points), [(0, 3)])

    def test_triangle(self):
        points = [(0, 3), (2, 2), (1, 1)] 
        self.assertEqual(convex_hull_jarvis(points), [(0, 3), (2, 2), (1, 1)])
